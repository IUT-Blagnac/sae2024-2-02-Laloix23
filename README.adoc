...
| 1    | link:src/SAEALGO/src/main/java/iut/sae/Algo.java[meilleur java]| Java     | Simplicité
| 2    | link:src/python/algo.py[meilleur Python]    | Python     | Simplicité
| 3  | link:src/python/algo.py[meilleur Python]    | Python       | Efficacité  
| 4    | link:src/SAEALGO/src/main/java/iut/sae/Algo.java[meilleur java]| Java     |  Efficacité 
| 5  | link:src/python/algo.py[meilleur Python]    | Python       | Sobriété numérique
| 6    | link:src/SAEALGO/src/main/java/iut/sae/Algo.java[meilleur java]| Java     | Sobriété numérique
|==========================================================================

=== Phase 2 (deadline : **vendredi 21 juin 2024** à minuit)

*  link:https://github.com/IUT-Blagnac/sae2024-2-02-Laloix23/blob/main/rapport/rapporteval.adoc[Rapport d'évaluation des algorithmes] Le rapport d'évaluation des algorithmes (e.g., asciidoc ou PDF). Pour chaque catégorie, vous devrez désigner qui est 1er, 2ème, 3ème, ... (avec possibilité d’ex-aequo si le hasard vous a attribué des algos similaires). Il doit se trouver dans le répertoire `rapport` de votre dépôt.
* link:https://github.com/IUT-Blagnac/sae2024-2-02-Laloix23/tree/main/analyse[Les codes de test] Les codes de test, d'évaluation ou de mesure. Ils doivent se trouver dans le répertoire `analyse` de votre dépôt.
...
=== Reproductibilité
. Sur Codacy nous pouvons lier notre compte github et ensuite nous pouvons récuperer la mesure de qualité du code selon un Grade

- Pour reproduire mes analyses pour le code Java :
. Mettre l'algorithme de ExecutionTester dans le même package que son algorithme
. Puis exécuter l'algo et récupérer le temps d'execution de votre algorithme

- Pour reproduire mes analyses pour le code Python
. Ajouter le code Test de Python a la suite de l'algorithme python et exécuter, si il y a une erreur l'algorithme a echoué le passage des tests

- Pour reproduire mes analyses pour le code C
. Ajouter le code Test en C a la suite de l'algorithme en C et exécuter, si il y a une erreur l'algorithme a echoué le passage des tests
